            ...
            <div class="form-content">
              <div class="form-details">
                ...
                <div class="row">
                  <div class="col">
                    ...
                    @enderror">
                      ...
                      <input type="number" 
                      value="{{old('price')}}" placeholder="Price" name="price" />
                  ...
                  <div class="col">
                    ...
                    @enderror">
                      ...
                      <input placeholder="Vin Code" maxlength="10"
                      value="{{old('vin')}}" name="vin" />
                ...
                @error('description')
                  ...
                  <textarea rows="10" name="description" style="resize: none">{{old('description')}}</textarea>
                  <p class="error-message">{{$errors->first('description')}}</p>
                </div>

              </div>

                {{-- This input for images with error validate --}}
              <div class="form-images">
                @foreach ($errors->get('images.*') as $imageError)
                ...
                <div class="form-image-upload">
                  ...
                  <input id="carFormImageUpload" type="file" name="images[]" multiple required/>
                </div>
